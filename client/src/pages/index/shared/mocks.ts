...
export const feedTasks: RoadTask[] = [
  { id: 'r1', title: '速度狂奔挑战', detail: '释放你的野性！30 分钟极速奔跑，让心跳与激情共振！释放自我！成就明天！让生活更有趣！让身体更健康！让心灵更自由！让世界更美好！', due: '今天', type: '力量', icon: '🏃', points: 20 },
  { id: 'r2', title: '万步征途', detail: '每一步都是胜利的足迹！今日目标：征服 10000 步', due: '今天', type: '敏捷', icon: '👟', points: 15 },
  { id: 'r3', title: '心灵静修之旅', detail: '进入禅定！15 分钟冥想修炼，恢复精神能量', due: '今天', type: '智慧', icon: '🧘', points: 12 },
  { id: 'r4', title: '钢铁战士修炼', detail: '突破极限！20 分钟力量训练，铸就无敌肌肉', due: '今天', type: '力量', icon: '💪', points: 25 },
  { id: 'r5', title: '疾风骑行传说', detail: '骑行 40 分钟，感受速度与自由的完美融合', due: '今天', type: '敏捷', icon: '🚴', points: 18 },
